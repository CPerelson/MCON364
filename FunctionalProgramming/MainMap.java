...
public class MainMap {
    ...
    public static void main(String[] args) {
        ...
        hashTable = choice == 1 ? new HashTable<>(50, HashTable.HashingStrategy.NAIVE) :
                choice == 2 ? new HashTable<>(50, HashTable.HashingStrategy.SOPHISTICATED) :
                        new HashTable<>(50, HashTable.HashingStrategy.NAIVE);
